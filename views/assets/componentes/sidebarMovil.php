<div class="offcanvas offcanvas-start bg-dark text-white" tabindex="-1" id="offcanvasSidebar"
    ...
    <div class="offcanvas-body">
        ...
        <li class="nav-item"><a href="dashboard.php?page=ver-reportes" class="nav-link text-white">
        ...
        <li class="nav-item">
            <a href="dashboard.php?page=hacer-reporte" class="nav-link text-white">
        ...
        <li class="nav-item"><a href="dashboard.php?page=mis-reportes" class="nav-link -text-white">
