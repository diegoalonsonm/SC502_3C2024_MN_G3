        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a href="dashboard.php?page=sensores" class="nav-link text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear-wide me-1" viewBox="0 0 16 16">
            ...
            <li class="nav-item">
                <a href="dashboard.php?page=alcantarillas" class="nav-link text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-signpost me-1" viewBox="0 0 16 16">
